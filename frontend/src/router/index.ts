...
const routes: Array<RouteRecordRaw> = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'review',
        name: 'NewsReview',
        component: () => import('@/views/admin/NewsReview.vue'),
        meta: { title: '新闻审核' }
      }
    ]
  },
  // 编辑权限路由
  {
    ...
    children: [
      {
        path: '',
        redirect: '/editor/news-list'
      },
      {
        path: 'news-list',
        name: 'EditorNewsList',
        component: () => import('@/views/editor/NewsList.vue'),
        meta: { title: '我的新闻' }
      },
      {
        path: 'news-editor',
        name: 'EditorNewsCreate',
        component: () => import('@/views/editor/NewsEditor.vue'),
        meta: { title: '创建新闻' }
      },
      {
        path: 'news-editor/:id',
      ...
      {
        path: 'statistics',
        name: 'EditorStatistics',
        component: () => import('@/views/editor/Statistics.vue'),
        meta: { title: '数据统计' }
      }
    ]
  },
